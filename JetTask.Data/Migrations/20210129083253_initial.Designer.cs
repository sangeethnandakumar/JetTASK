...
namespace JetTask.Data.Migrations
{
    ...
    [Migration("20210129083253_initial")]
            ...
            modelBuilder.Entity("JetTask.Entities.Client", b =>
                {
                    b.HasOne("JetTask.Entities.User", "CreatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.Client", "CreatedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("JetTask.Entities.User", "UpdatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.Client", "UpdatedById")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("JetTask.Entities.Project", b =>
                {
                    ...
                    b.HasOne("JetTask.Entities.User", "CreatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.Project", "CreatedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("JetTask.Entities.User", "UpdatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.Project", "UpdatedById")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("JetTask.Entities.User", b =>
                {
                    b.HasOne("JetTask.Entities.User", "CreatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.User", "CreatedById")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("JetTask.Entities.User", "UpdatedBy")
                        .WithOne()
                        .HasForeignKey("JetTask.Entities.User", "UpdatedById")
                        .OnDelete(DeleteBehavior.NoAction);
